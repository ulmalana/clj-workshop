(ns ch09-support-desk.core-test
    (:require
     ...
     [cuerdas.core :as str]
     [ch09-support-desk.utils :refer [delete-item-from-list-by-title
                                      get-priorities-list
                                      get-sort-message
                                      get-sorted-priorities-list
                                      handle-sort-finish]]))

(use-fixtures :each
  {:before (fn [] (do
                    (def priorities-list [{:title "IE bugs" :priority 2}
...
(deftest get-priorities-list-test
  (testing "testing filtering priorities based on priority number"
    (is (= [] (get-priorities-list priorities-list 0)))
...
(deftest delete-item-from-list-by-title-test
  (testing "Passing empty list"
    (is (= [] (delete-item-from-list-by-title "Login token" [])))
    (is (= [] (delete-item-from-list-by-title "Login token" nil))))
